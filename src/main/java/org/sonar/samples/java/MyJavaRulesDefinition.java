...
public class MyJavaRulesDefinition implements RulesDefinition {
  ...
  public static final String REPOSITORY_KEY = "bsl-java";
  ...
  private List<Class> getChecks() {
	    ImmutableList.Builder<Class> checksBuilder = ImmutableList.<Class>builder().addAll(RulesList.getCheckClasses());	   
