...
import org.sonar.samples.java.checks.AvoidClassInstanceObjectRule;
...
import org.sonar.samples.java.checks.XPathCheckRule;
...
public final class RulesList {
  ...
  public static List<Class<? extends JavaCheck>> getJavaChecks() {
    return Collections.unmodifiableList(Arrays.asList(
      ...
      AvoidClassInstanceObjectRule.class));
  }
